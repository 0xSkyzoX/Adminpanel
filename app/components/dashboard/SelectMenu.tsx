...
const Menu: React.FC<{ updateModuleForm: React.Dispatch<React.SetStateAction<Box>>}> = ({updateModuleForm}) => {
  return (
    <div className="mt-2">
      <label
        htmlFor="location"
      ...
      <select
        ...
        name="location"
        onChange={(e) => {
          updateModuleForm((prev) => ({...prev, license: e.target.value == 'true' && true}))
        }}
